...
void PassageTokenizer::nextSection(Passage& pass)
{
    ...
    else if (passageText.substr(pass.ptIndex, 9) == "(else-if:")
    {
        ...
        SectionToken stok(ptokenText);
        Elseif elseif(stok);
        pass.commands.push_back(elseif);
    }
